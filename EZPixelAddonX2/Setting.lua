...
if EZPixelAddonX2DB == nil then
    EZPixelAddonX2DB = {}
end

addonTable.FPS = EZPixelAddonX2DB.FPS or 15
addonTable.RangeCheck = EZPixelAddonX2DB.RangeCheck or 40
addonTable.LowFrequencyFPS = EZPixelAddonX2DB.LowFrequencyFPS or 5
...
do
    ...
    local function SetValue(value)
        ...
        EZPixelAddonX2DB.LowFrequencyFPS = value
    end
...
do
    ...
    local function SetValue(value)
        ...
        EZPixelAddonX2DB.RangeCheck = value
    end
